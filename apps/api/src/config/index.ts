...
function getCorsOrigins(): string[] {
  ...
  if (nodeEnv === 'production') {
    return ['https://tokenrewards.devingray.io'];
  }
...
export const config = {
  ...
  rewards: {
    ...
    minClaimIntervalHours: parseInt(
      process.env.MIN_CLAIM_INTERVAL_HOURS || '24',
      10
    ),
...
export function validateConfig(): void {
  ...
  if (missing.length > 0) {
    ...
    console.error(
      'Please set these environment variables in your Railway service settings.'
    );
