-- Initialize database for Reward System
-- This script sets up the basic database structure

-- Create database if it doesn't exist
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_database WHERE datname = 'reward_system') THEN
        EXECUTE 'CREATE DATABASE reward_system';
    END IF;
END $$;

-- Connect to the reward_system database
\c reward_system;
...
-- Insert default reward configuration (optional)
